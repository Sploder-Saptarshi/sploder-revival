...
<?php include('../content/headernavigation.php'); ?>
        ...
        <div id="content"><h3>My Avatar</h3><p>Make your own Sploder avatar. Change the settings below and click <em>SAVE AVATAR</em> to save your new creation. If you really want to spice up your avatar, create a <a href="/accounts/avatar.php?set=2">Premium Avatar!</a></p><div id="rpc_messages"></div><div id="avatar_editor">
    ...
    <div id="controls">
        <div id="control_01" class="control">
            ...
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_01" value="up">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_01" value="down">
            <label>Skin Color</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_01" value="prev">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_01" value="next">
        </div>
        <div id="control_02" class="control">
            <label>Mouth Style</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_02" value="prev">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_02" value="next">
        </div>
        ...
        <div id="control_04" class="control">
            ...
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_04" value="prev">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_04" value="next">
            <label>Eye Color</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_04" value="up">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_04" value="down">
        </div>
        <div id="control_05" class="control">
            <label>Hair Style</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_05" value="prev">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_05" value="next">
            <label>Hair Color</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_05" value="up">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_05" value="down">
        </div>
        <div id="control_06" class="control">
            <label>Extras Choice</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_06" value="prev">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_06" value="next">
	    <label>Extras Color</label>
            <input type="image" src="/avatar/avatar_controls_prev.gif" class="control_prev controller" name="layer_06" value="up">
            <input type="image" src="/avatar/avatar_controls_next.gif" class="control_next controller" name="layer_06" value="down">
	</div>
        <div class="clear"></div>
    </div>
    ...
    <div class="promo gamerating"><span>This avatar maker was created by malware8148! Please report any bugs or issues to him. This should function just like Sploder's original avatar maker.</span></div>
    <div class="buttons">
    ...
    <input type="hidden" id="newURL" size="40" value="https://sploder.xyz/classic-0"></div>
</div>
...
if (getUrlParameter("set") == "2") {
    for (i = 0; i < styles.length; i++) {
        $(".layer_0" + (i + 1)).css({"background": "url(/avatar/avatar_0" + (i + 1) + "_96.png.1)"});
    }
    type = "premium";
    $(".firstbutton a").text("Make a Classic Avatar »");
    $(".firstbutton a").attr("href","/accounts/avatar.php");
    $("#content p").html('Make your own Sploder avatar. Change the settings below and click <em>SAVE AVATAR</em> to save your new creation. If you are bored of premium avatars, go back and create a <a href="/accounts/avatar.php">Classic Avatar!</a>');
}
